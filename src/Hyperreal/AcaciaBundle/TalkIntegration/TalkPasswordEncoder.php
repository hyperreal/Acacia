...
namespace Hyperreal\AcaciaBundle\TalkIntegration;

use Hyperreal\AcaciaBundle\Exception\AcaciaException;
use Symfony\Component\Security\Core\Encoder\BasePasswordEncoder;

/**
 * This is an encoder that can check password stored in the database by phpBB v3.*
 *
 * Class TalkPasswordEncoder
 * @package Hyperreal\AcaciaBundle\TalkIntegration
 */
class TalkPasswordEncoder extends BasePasswordEncoder
{
    ...
    {
        throw new AcaciaException('Registration is currently not supported');
    }
